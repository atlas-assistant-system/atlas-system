...
public record MovementNote(String value) implements SingleValueObject<String> {
    ...
    public static Result<Optional<MovementNote>> create(String value) {
        ...
        if (trimmed.length() > MAX_LENGTH) {
            return Result.failure(MovementErrors.NOTE_TOO_LONG);
        }
