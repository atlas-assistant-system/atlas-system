...
public final class UiHandlers {
    ...
    private static final String PAGE = StaticResources.read("/web-routines/app.html");
    private static final String STYLES = StaticResources.read("/web-routines/app.css");
    private static final String SCRIPT = StaticResources.read("/web-routines/app.js");
