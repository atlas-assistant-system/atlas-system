...
public final class DocsHandlers {
    ...
    private static final String SWAGGER_PAGE = StaticResources.read("/web-training/swagger.html");
    private static final String OPENAPI_SPEC = StaticResources.read("/web-training/openapi.json");
