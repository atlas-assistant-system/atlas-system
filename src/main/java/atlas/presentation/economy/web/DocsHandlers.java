...
public final class DocsHandlers {
    ...
    private static final String SWAGGER_PAGE = StaticResources.read("/web-economy/swagger.html");
    private static final String OPENAPI_SPEC = StaticResources.read("/web-economy/openapi.json");
