...
public final class SqliteAppointmentUnitOfWork extends AbstractUnitOfWork implements AppointmentUnitOfWork {

    private final Connection connection;
    private final SqliteAppointmentRepository appointments;

    public SqliteAppointmentUnitOfWork(Connection connection, EventDelivery delivery, SequenceGenerator sequences) {
        super(delivery);
